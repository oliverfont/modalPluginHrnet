...
var Modal = function (_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, children = _a.children, title = _a.title, _b = _a.size, size = _b === void 0 ? 'medium' : _b, closeIcon = _a.closeIcon, _c = _a.customStyles, customStyles = _c === void 0 ? {} : _c, _d = _a.closeButtonStyles, closeButtonStyles = _d === void 0 ? {} : _d;
    if (!isOpen)
        return null;
